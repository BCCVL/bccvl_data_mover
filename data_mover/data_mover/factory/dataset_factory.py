...
class DatasetFactory():
    ...
    def generate_dataset(self, ala_occurrence):
        ...
        occurrence_file = DatasetFile(path_to_url(ala_occurrence.occurrence_path), DatasetFile.TYPE_OCCURRENCES, os.path.getsize(ala_occurrence.occurrence_path))
        metadata_file = DatasetFile(path_to_url(ala_occurrence.metadata_path), DatasetFile.TYPE_ATTRIBUTION, os.path.getsize(ala_occurrence.metadata_path))
