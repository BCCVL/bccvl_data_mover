...
from data_mover import ALA_SERVICE, ALA_JOB_DAO, DESTINATION_MANAGER
...
class DataMoverServices(XMLRPCView):
    ...
    def pullOccurrenceFromALA(self, lsid=None):
        ...
        """
        if lsid is None:
            return error_rejected(MISSING_PARAMS)
        else:
    ...
    def checkALAJobStatus(self, id=None):
        ...
        if not isinstance(id, int):
            return error_rejected(INVALID_PARAMS)
        ...
        if job is not None:
            ...
            return error_rejected(JOB_DOES_NOT_EXIST)
    ...
    def move(self, destination_dict, source_dict):
        ...
        if destination is None:
            return error_rejected(UNKNOWN_DESTINATION)
